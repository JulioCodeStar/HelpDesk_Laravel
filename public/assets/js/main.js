(() => {
	...
	const initSidebarMenu = () => {
		...
		/* =============================
		   ACTIVE STATE
		   El estado activo ya lo calcula Blade en el servidor
		   (routeIs() en sidebar.blade.php); aquí solo sincronizamos
		   las clases que dependen de eso en el DOM.
		============================= */

		// icono del tab: sigue lo que Blade puso en aria-selected
		$('.app-menubar-tabs .menu-link[aria-selected="true"]').addClass('active');

		// abre el submenú (menu-inner) del link ya marcado "active" por Blade
		var $activeLink = $('.app-navbar a.active').first();
