...
!function (e, t) {
    ...
    const o = {}, i = e => new Promise(t => {
        ...
        O = () => w(r.actions), M = () => w(r.footer), H = () => w(r["timer-progress-bar"]), j = () => w(r.close),
        I = () => {
            const e = C();
            if (!e) return [];
        ...
        V = () => {
        ...
        }, N = (e, t) => !!t && t.split(/\s+/).every(t => e.classList.contains(t)), _ = (e, t, n) => {
            if (((e, t) => {
            ...
            U(e, t, !1)
        }, K = (e, t) => Array.from(e.children).find(e => e instanceof HTMLElement && N(e, t)), Y = (e, t, n) => {
        ...
        te = e => Boolean(e.scrollHeight > e.clientHeight), ne = e => {
        ...
        se = () => {
            ...
            i.appendChild(n), e.topLayer && (n.setAttribute("popover", ""), n.showPopover()), (e => {
                ...
                const e = C();
                if (!e) return;
                const t = K(e, r.input), n = K(e, r.file), o = e.querySelector(`.${r.range} input`),
            ...
            n && o && (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? X(n) : Z(n), _(n, t, "actions"), function (e, t, n) {
                ...
                de(o, "confirm", n), de(i, "deny", n), de(s, "cancel", n), function (e, t, n, o) {
                    ...
                    i.forEach(([e, t, n]) => {
                        n && e.style.setProperty(`--swal2-${t}-button-background-color`, n), function (e) {
    ...
    var me = {innerParams: new WeakMap, domCache: new WeakMap, focusedElement: new WeakMap};
    const he = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], ge = e => {
        ...
        if (o) {
            (e => {
                for (const {name: t} of Array.from(e.attributes)) ["id", "type", "value", "style"].includes(t) || e.removeAttribute(t)
            })(o);
    ...
    Ae.text = Ae.email = Ae.password = Ae.number = Ae.tel = Ae.url = Ae.search = Ae.date = Ae["datetime-local"] = Ae.time = Ae.week = Ae.month = (e, t) => {
        ...
        const n = e, o = n.querySelector("input"), i = n.querySelector("output");
    ...
    const He = e => {
        ...
        ze = e => {
            ...
            const t = e.target, n = I().findIndex(e => e === t);
            let o = !0;
    ...
    const tt = () => {
        ...
        ot = nt && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream, it = () => {
            const e = y();
            if (!e) return;
            let t;
            e.ontouchstart = e => {
    ...
    function dt(e) {
        e = gt(e);
        const t = et.swalPromiseResolve.get(this), n = pt(this);
    ...
    const $t = e => (e instanceof Map ? Array.from(e) : Object.entries(e)).map(([e, t]) => [e, "object" == typeof t ? $t(t) : t]),
        Lt = (e, t) => Boolean(t) && null != t && t.toString() === e.toString(), Pt = (e, t) => {
            const n = me.innerParams.get(e);
    ...
    const jt = e => {
        const t = e.loader.getAttribute("data-button-to-replace"), n = t ? e.popup.getElementsByClassName(t) : [];
