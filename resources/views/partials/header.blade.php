                ...
                <ul class="d-flex align-items-center ps-0 mb-0 list-unstyled justify-content-center justify-content-md-start">
                    ...
                    <li class="w-100">
                        <form class="src-form position-relative" onsubmit="return false;">
                            <input class="form-control" placeholder="Buscar tickets, usuarios..." type="text"/>
                ...
                <ul class="d-flex align-items-center justify-content-center justify-content-md-end ps-0 mb-0 list-unstyled">
                        ...
                        <div class="dropdown notifications noti messages">
                            ...
                            <div class="dropdown-menu dropdown-lg p-0 border-0 p-0 dropdown-menu-end">
                                <div class="d-flex justify-content-between align-items-center title">
                                    ...
                                    <button class="p-0 m-0 bg-transparent border-0 fs-15 text-primary fw-medium">
                                        Mark all as read
                                    </button>
                                </div>
                                <div data-simplebar="" style="max-height: 300px;">
                                        ...
                                        <a class="dropdown-item" href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img alt="images" class="rounded-circle" src="assets/images/user1.jpg" style="width: 44px; height: 44px;"/>
                                                </div>
                                                <div class="flex-grow-1 ms-10">
                                                    ...
                                                    <span class="fs-14-5 fw-medium d-inline-block" style="line-height: 1.4;">
                                    ...
                                    <div class="notification-menu unseen">
                                        <a class="dropdown-item" href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img alt="images" class="rounded-circle" src="assets/images/user2.jpg" style="width: 44px; height: 44px;"/>
                                                </div>
                                                <div class="flex-grow-1 ms-10">
                                                    <p class="fs-16 fw-medium text-secondary mb-2">
                                                        Angela Carter
                                    ...
                                    <div class="notification-menu">
                                        <a class="dropdown-item" href="chat.html">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img alt="images" class="rounded-circle" src="assets/images/user3.jpg" style="width: 44px; height: 44px;"/>
                                                </div>
                                                <div class="flex-grow-1 ms-10">
                                                    <p class="fs-16 fw-medium text-secondary mb-2">
                                                        Brad Traversy
                                ...
                                <a class="dropdown-item text-center text-primary d-block view-all fw-medium rounded-bottom-3" href="chat.html">
                                                <span>
                                                See All Messages
                                                </span>
                                </a>
                    ...
                    <li class="header-right-item">
                        <div class="dropdown notifications noti">
                            <button aria-expanded="false" class="btn btn-secondary icon-btn border-0 p-0 position-relative" data-bs-toggle="dropdown" type="button">
                            ...
                            <div class="dropdown-menu dropdown-lg p-0 border-0 dropdown-menu-end">
                                <div class="d-flex justify-content-between align-items-center title">
                                    <span class="fw-medium fs-16 text-secondary">
                                        Notificaciones <span class="fw-normal text-body fs-16">(03)</span>
                                    </span>
                                    <button class="p-0 m-0 bg-transparent border-0 fs-15 text-primary fw-medium">
                                        Limpiar todo
                                    </button>
                                ...
                                <div data-simplebar="" style="max-height: 300px;">
                                    <div class="notification-menu unseen">
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <i class="material-symbols-outlined text-primary">confirmation_number</i>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <p class="fs-16 fw-medium text-secondary">Se creó un nuevo ticket #1056</p>
                                                    <span class="fs-14 fw-medium">hace 2 h</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="notification-menu unseen">
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <i class="material-symbols-outlined text-info">assignment_ind</i>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <p class="fs-16 fw-medium text-secondary">Se te asignó el ticket #1054</p>
                                                    <span class="fs-14 fw-medium">hace 3 h</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="notification-menu">
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <i class="material-symbols-outlined text-success">task_alt</i>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <p class="fs-16 fw-medium text-secondary">El ticket #1049 fue cerrado</p>
                                                    <span class="fs-14 fw-medium">hace 1 día</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                        ...
                        <div class="dropdown admin-profile">
                            <div class="d-xxl-flex align-items-center bg-transparent border-0 text-start p-0 cursor dropdown-toggle" data-bs-toggle="dropdown">
                                <div class="flex-shrink-0 position-relative">
                                    <img alt="perfil" class="rounded-circle admin-img-width-for-mobile" src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'Panda Noir') }}&background=0D8ABC&color=fff" style="width: 40px; height: 40px;"/>
                            ...
                            <div class="dropdown-menu border-0 bg-white dropdown-menu-end">
                                <div class="d-flex align-items-center info">
                                    <div class="flex-shrink-0">
                                        <img alt="avatar de {{ auth()->user()->name }}"
                                    ...
                                    <div class="flex-grow-1 ms-10">
                                        <h3 class="fw-medium fs-17 mb-0">{{ auth()->user()->name ?? 'Panda Noir' }}</h3>
                                        <span class="fs-15 fw-medium">{{ ucfirst(auth()->user()->role->name ?? 'Admin') }}</span>
                                    </div>
                                </div>
